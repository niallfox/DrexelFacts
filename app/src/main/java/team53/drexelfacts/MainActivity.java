...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // show title "Drexel Facts" in toolbar.
        getSupportActionBar().setTitle("Drexel Facts");
        ...
        new Firebase("https://drexel-facts-73ece.firebaseio.com/drexelFacts")
        ...
        String message = "Learn more about Drexel University one fact at a time!";
    ...
    private void getForecast() {
        String apiKey = "0b198ec3b805c7a335c0292b86342815";
        double latitude = 39.9504;
        double longitude = -75.1925;
